<?php
	...
	use PhoenixSNS\ResourceBundle;
	use PhoenixSNS\Pages\DashboardPage;
	use PhoenixSNS\Pages\MainPage;
	use PhoenixSNS\Pages\ErrorPage;
	use PhoenixSNS\Pages\LoginPage;
	...
	System::$Modules[] = new Module("net.phoenixsns.Default", array
	(
