<?php
	...
	$tables[] = new Table("Modules", "module_", array
	(
	...
	$tables[] = new Table("ModuleMenuItems", "menuitem_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("ID", "INT", null, null, false, true, true),
	...
	$tables[] = new Table("ModuleObjects", "object_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("ID", "INT", null, null, false, true, true),
	...
	$tables[] = new Table("ModulePages", "modulepage_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("ID", "INT", null, null, false, true, true),
