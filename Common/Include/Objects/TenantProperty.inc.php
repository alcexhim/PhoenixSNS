<?php
	...
	class TenantProperty
	{
		...
		public static function Create($property, $tenant = null)
		{
			...
			if ($result === false)
			{
				PhoenixSNS::Log("Database error when trying to create a property on the tenant.", array
				(
		...
		public function Delete()
		{
			...
			$query = "DELETE FROM " . System::$Configuration["Database.TablePrefix"] . "TenantProperties WHERE property_ID = " . $this->ID;
			$result = $MySQL->query($query);
			return ($result !== false);
		}
	}
