<?php
	...
	(
		new Record(array
		(
			new RecordColumn("Name", "English (United States)")
		)),
		new Record(array
		(
			new RecordColumn("Name", "Spanish")
		)),
		new Record(array
		(
			new RecordColumn("Name", "Japanese")
		))
	));
	$tables[] = $tblLanguages;
	
	$tblLanguageStrings = new Table("LanguageStrings", "languagestring_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
