<?php
	...
	(
		...
		new Column("DefaultPropertyID", "INT", null, null, true)
	));
	...
	(
		...
		new Column("ColumnVisible", "INT", null, 1, false)
	));
	...
	// Object instance method namespace references.
	...
	// Object static property journals.
	$tblTenantObjectPropertyJournals = new Table("TenantObjectPropertyJournals", "journal_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("ID", "INT", null, null, false, true, true),
		new Column("ObjectID", "INT", null, null, false),
	...
	$tblTenantObjectPropertyJournals->ForeignKeys = array
	(
		new TableForeignKey("ObjectID", new TableForeignKeyColumn($tblTenantObjects, "ID")),
		new TableForeignKey("CreationUserID", new TableForeignKeyColumn($tblUsers, "ID"))
	);
	$tables[] = $tblTenantObjectPropertyJournals;
	
	// Object static property journal entries.
	$tblTenantObjectPropertyJournalEntries = new Table("TenantObjectPropertyJournalEntries", "entry_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("JournalID", "INT", null, null, false),
		new Column("PropertyID", "INT", null, null, false),
		new Column("PropertyValue", "LONGBLOB", null, null, false)
	));
	$tblTenantObjectPropertyJournalEntries->ForeignKeys = array
	(
		new TableForeignKey("JournalID", new TableForeignKeyColumn($tblTenantObjectPropertyJournals, "ID")),
		new TableForeignKey("PropertyID", new TableForeignKeyColumn($tblTenantObjectProperties, "ID"))
	);
	$tables[] = $tblTenantObjectPropertyJournalEntries;
	
	// Object instance property journals.
	$tblTenantObjectInstancePropertyJournals = new Table("TenantObjectInstancePropertyJournals", "journal_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("ID", "INT", null, null, false, true, true),
		new Column("ObjectID", "INT", null, null, false),
	...
	$tblTenantObjectInstancePropertyJournals->ForeignKeys = array
	(
		new TableForeignKey("ObjectID", new TableForeignKeyColumn($tblTenantObjects, "ID")),
		new TableForeignKey("InstanceID", new TableForeignKeyColumn($tblTenantObjectInstances, "ID")),
		new TableForeignKey("CreationUserID", new TableForeignKeyColumn($tblUsers, "ID"))
	);
	$tables[] = $tblTenantObjectInstancePropertyJournals;
	
	// Object instance property journal entries.
	$tblTenantObjectInstancePropertyJournalEntries = new Table("TenantObjectInstancePropertyJournalEntries", "entry_", array
	(
		// 			$name, $dataType, $size, $value, $allowNull, $primaryKey, $autoIncrement
		new Column("JournalID", "INT", null, null, false),
		new Column("PropertyID", "INT", null, null, false),
	...
	$tblTenantObjectInstancePropertyJournalEntries->ForeignKeys = array
	(
		new TableForeignKey("JournalID", new TableForeignKeyColumn($tblTenantObjectInstancePropertyJournals, "ID")),
		new TableForeignKey("PropertyID", new TableForeignKeyColumn($tblTenantObjectInstanceProperties, "ID"))
	);
	$tables[] = $tblTenantObjectInstancePropertyJournalEntries;
?>